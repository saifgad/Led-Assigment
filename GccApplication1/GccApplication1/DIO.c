...
void DIO_SetPin_Dir(Uint8 port_name, Uint8 pin_name, Uint8 pin_dir)
{
	switch(pin_dir)
	{
		...
		{
			case DIO_PORTA:
			Clear_Bit(DRRA,pin_name);
			break;
			case DIO_PORTB:
			Clear_Bit(DRRB,pin_name);
			break;
			case DIO_PORTC:
			Clear_Bit(DRRC,pin_name);
			break;
			case DIO_PORTD:
			Clear_Bit(DRRD,pin_name);
			break;
			default:
			break;
		}
		...
		{
			case DIO_PORTA:
			Set_Bit(DRRA,pin_name);
			break;
			case DIO_PORTB:
			Set_Bit(DRRB,pin_name);
			break;
			case DIO_PORTC:
			Set_Bit(DRRC,pin_name);
			break;
			case DIO_PORTD:
			Set_Bit(DRRD,pin_name);
			break;
			default:
			break;
		}
